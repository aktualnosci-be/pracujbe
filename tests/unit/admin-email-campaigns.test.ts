...
/**
 * #45 (otwarte) — panel admina kampanii e-mail: reguły (lustro RPC 0111), gotowość nadawcy,
...
const MIGRATION = readFileSync(
  resolve(process.cwd(), 'supabase/migrations/0111_admin_email_campaigns.sql'),
  'utf8',
);
...
describe('reguły statusów (lustro RPC 0111)', () => {
