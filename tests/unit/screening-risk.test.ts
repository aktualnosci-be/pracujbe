 ...
 * Decyzja jest w bazie (migracja 0103); tu: zachowanie wzorców, brak fałszywych trafień
 * na typowe pytania o warunki pracy i zgodność TS ↔ SQL (te same wzorce i składanie znaków).
 */

const MIGRATION = readFileSync(
  join(process.cwd(), 'supabase/migrations/0103_screening_question_review.sql'),
  'utf8',
);
...
describe('zgodność z migracją 0103', () => {
