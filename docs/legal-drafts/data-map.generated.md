...
- **Migracja:** `supabase/migrations/0115_contact_messages.sql`
...
- **Uwaga:** Wiadomości z formularza kontaktu (0115). Retencja i powiązanie z eksportem/usunięciem konta — do decyzji właściciela (#486).

| Kolumna | Kategoria | Wprowadzona w |
|---|---|---|
| `sender_id` | Powiązanie z osobą (identyfikator konta/profilu) | `supabase/migrations/0115_contact_messages.sql` |
| `sender_name` | Identyfikacja (imię, nazwisko, zdjęcie, rola) | `supabase/migrations/0115_contact_messages.sql` |
| `sender_email` | Dane kontaktowe (e-mail, telefon) | `supabase/migrations/0115_contact_messages.sql` |
| `topic` | Korespondencja i treści swobodne | `supabase/migrations/0115_contact_messages.sql` |
| `message` | Korespondencja i treści swobodne | `supabase/migrations/0115_contact_messages.sql` |
| `locale` | Preferencje i ustawienia (język, powiadomienia, wyszukiwania, blokady) | `supabase/migrations/0115_contact_messages.sql` |
| `handled_by` | Powiązanie z osobą (identyfikator konta/profilu) | `supabase/migrations/0115_contact_messages.sql` |
