...
Tabele w migracjach: 82; z danymi osobowymi: 49; bez danych osobowych: 33.
...
- **Migracja:** `supabase/migrations/0103_dsa_appeals.sql`
...
| Kolumna | Kategoria | Wprowadzona w |
|---|---|---|
| `appellant_id` | Powiązanie z osobą (identyfikator konta/profilu) | `supabase/migrations/0103_dsa_appeals.sql` |
| `appellant_locale` | Preferencje i ustawienia (język, powiadomienia, wyszukiwania, blokady) | `supabase/migrations/0103_dsa_appeals.sql` |
| `grounds` | Korespondencja i treści swobodne | `supabase/migrations/0103_dsa_appeals.sql` |
| `outcome_reasoning` | Zgłoszenia treści i decyzje moderacyjne | `supabase/migrations/0103_dsa_appeals.sql` |
| `decided_by` | Powiązanie z osobą (identyfikator konta/profilu) | `supabase/migrations/0103_dsa_appeals.sql` |
