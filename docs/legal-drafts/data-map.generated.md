...
- **Migracja:** `supabase/migrations/0113_message_attachments.sql`
- **Czynności:** Kontakt pracodawca–kandydat
- **Osoby:** Kandydaci (konto), Pracodawcy i członkowie firm
...
| Kolumna | Kategoria | Wprowadzona w |
|---|---|---|
| `uploader_id` | Powiązanie z osobą (identyfikator konta/profilu) | `supabase/migrations/0113_message_attachments.sql` |
| `file_id` | Powiązanie z osobą (identyfikator konta/profilu) | `supabase/migrations/0113_message_attachments.sql` |
| `message_id` | Powiązanie z osobą (identyfikator konta/profilu) | `supabase/migrations/0113_message_attachments.sql` |
