...
| `kind` | Dowody zgód i akceptacji dokumentów | `supabase/migrations/0107_consent_separation.sql` |
| `source` | Dowody zgód i akceptacji dokumentów | `supabase/migrations/0107_consent_separation.sql` |
