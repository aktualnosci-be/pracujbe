...
użytkownika i firmy (test z kontrolą ujemną). A2 nie ma jeszcze logu (`usageLogged: false`). A4 zapisuje ten sam wiersz (`feature: cv_profile_import`, `inputKind: text`), A5 — `feature: profile_answers_assist`, `inputKind: text`.
