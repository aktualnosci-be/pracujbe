...
| `analytics-marketing` | Statystyka odwiedzin (#570) | Zakres ustala skrypt beaconu (adres strony, referrer, dane techniczne, IP połączenia) | — | Cloudflare Web Analytics | Cookie zgody 180 dni; beacon bez cookies | Ładowanie wyłącznie po zgodzie analitycznej (Invariant #7) | do ustalenia | właściciel + prawnik |
