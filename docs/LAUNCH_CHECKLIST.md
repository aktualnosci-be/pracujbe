...
| W12 | P1 | Okresy retencji i DSA (#40, #574): terminy DSA zatwierdzone 26.09.2026 (odwołanie 6 mies., rozpatrzenie 14 dni, retencja 12 mies.), `DSA_RETENTION_MODE=dry-run` na produkcji; do decyzji: okresy #574 i `RETENTION_MODE`, `apply` dla DSA, `STORAGE_GC_MODE` (dry-run) — wymaga też W2 | dane trzymane bez terminu |
