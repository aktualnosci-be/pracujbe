...
| `AI_PROFILE_ASSIST_ENABLED`, `AI_PROFILE_ASSIST_MODEL` | asystent budowania profilu kandydata z odpowiedzi (#37, `docs/AI_PROFILE_ASSIST.md`), domyślnie wyłączony; ten sam `ANTHROPIC_API_KEY` |
...
| `AI_JOB_IMPORT_PROVIDER`, `AI_JOB_ASSIST_PROVIDER`, `AI_CV_IMPORT_PROVIDER`, `AI_PROFILE_ASSIST_PROVIDER` | atrapy testowe; ignorowane przy `APP_MODE=production` |
