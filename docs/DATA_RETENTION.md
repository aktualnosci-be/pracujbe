...
| `acceptance_ip_user_agent` | 7 dni | job | zeruje IP i user-agent receiptu akceptacji przy rejestracji (0130, krok `retention_purge_receipts_batch`); receipt zostaje |
