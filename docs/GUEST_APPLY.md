...
dostaje powiadomienia in-app, ale od `0108` dostaje e-mail `guestStatusChanged` (niżej,
...
`enqueue_guest_status_email` (0108). E-maile do
...
Najpierw cofnij `0108`: odtwórz `transition_application` z `0095` i usuń
