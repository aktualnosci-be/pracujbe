...
Kontynuacja: fotograficzny nagłówek strony głównej używa lokalnego WebP (90 KB) z zatwierdzonego projektu. Sprawdzono w przeglądarce układ desktop i ładowanie zdjęcia/overflow na 320 px w czterech językach. Szczegóły oraz podobne oferty korzystają z tego samego formattera stawek co paszport: bez zaokrąglania groszy, z od/do i bez deklarowania negocjacji przy braku kwoty (#22). Pełna przebudowa detalu, filtrów oraz kontrola 200% nadal pozostają otwarte. Walidacja tej partii: 74 unit, 24 E2E zaliczone, 1 E2E pominięty.
