...
// fallback na własny build. Od #570 GA/Meta Pixel usunięte — ich zmienne w ci.yml są martwe;
// testowy token Cloudflare (NEXT_PUBLIC_CF_ANALYTICS_TOKEN) włącza pozytywne scenariusze E2E
// beaconu (bez niego są jawnie pomijane, playwright.config.ts).
