-- =============================================================================
-- CJ186-R — rollback migracji 0099 (#186). Uruchamiany przez scripts/test-rls.sh po
...
begin;
\ir ../rollback/0099_campaign_job_source.down.sql
