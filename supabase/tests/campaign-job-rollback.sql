-- =============================================================================
-- CJ186-R — rollback migracji 0102 (#186). Uruchamiany przez scripts/test-rls.sh po
...
begin;
\ir ../rollback/0102_campaign_job_source.down.sql
