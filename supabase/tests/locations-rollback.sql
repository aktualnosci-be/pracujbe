-- =============================================================================
-- LOC194-R — rollback migracji 0109 (#194). Uruchamiany przez scripts/test-rls.sh po
...
begin;
\ir ../rollback/0109_locations_be_municipalities.down.sql
select pg_temp.assert(to_regclass('public.location_aliases') is null
  ...
  'LOC194-R rollback usuwa tylko dane i obiekty 0109');
rollback;
...
\echo 'LOC194-R rollback 0109: PASS'
