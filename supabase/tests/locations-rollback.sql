-- =============================================================================
-- LOC194-R — rollback migracji 0112 (#194). Uruchamiany przez scripts/test-rls.sh po
...
select pg_temp.assert(to_regclass('public.location_aliases') is null
  ...
  'LOC194-R rollback usuwa tylko dane i obiekty 0112');
rollback;
...
\echo 'LOC194-R rollback 0112: PASS'
