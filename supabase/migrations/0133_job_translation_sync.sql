-- =============================================================================
-- 0133_job_translation_sync.sql — #33: automatyczne tłumaczenie ofert i ponowienie po każdej
-- edycji (na rdzeniu kolejki 0127, #31/#32).
--
-- Numer tymczasowy (koordynator nadaje ostateczny). Zależy od 0127_translation_queue.sql.
--
...
--
-- Rollback: drop triggerów trg_job_translation_sync_* i funkcji z tej migracji; kolejka 0127
