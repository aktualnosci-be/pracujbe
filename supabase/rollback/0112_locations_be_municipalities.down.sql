-- =============================================================================
-- Rollback 0112 — słownik miejscowości z aliasami (#194). Uruchamiać ręcznie jako migrator,
...
-- w transakcji i cofa).
--
-- Usuwa aliasy i miejscowości dodane przez 0112 (z kodem NIS albo rodzaju innego niż
-- `municipality`), poza 10 miastami z 0010; te wracają do stanu sprzed 0112. Żadna tabela
