...
- [x] SEO: sitemap.ts (pusty na non-prod), robots.ts, metadata + hreflang, X-Robots-Tag
  ...
  Linki do zatwierdzenia (decyzja właściciela 26.09.2026, migracja `0207` — numer tymczasowy):
  ...
  ustala tylko admin; adresy sprzed 0207 zostają publiczne. Firma nadal `verified`. UI:
  ...
  akcja `reviewCompanyLink`). Dowód: `rls.sql` sekcja CL207 (kontrola ujemna: bez strażnika
