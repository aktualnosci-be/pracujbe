...
- [~] Wiadomości — konwersacje/wątek/wysyłka/przeczytania, zgłoszenia i załączniki gotowe (RPC 0016 + UI `/…/wiadomosci`, zweryfikowane na PG16)
  ...
  Podgląd i e-mail (migracja `0132` — numer tymczasowy): JPG/PNG dopuszczone do pobrania mają
  ...
  Dowód: `rls.sql` sekcja MN132 (kontrola ujemna: bez warunku blokady MN132-4 czerwony), unit
