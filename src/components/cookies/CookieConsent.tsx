 ...
 *   jak akceptacja (ten sam wariant i rozmiar przycisku).
 * - „Dostosuj" oraz przycisk w stopce otwierają panel (Dialog) z przełącznikami kategorii;
 *   `necessary` jest zawsze aktywna i zablokowana.
    ...
    <>
      ...
      <Dialog.Root open={settingsOpen} onOpenChange={setSettingsOpen}>
        <Dialog.Portal>
          ...
          <Dialog.Content
            className="fixed left-1/2 top-1/2 z-50 flex max-h-[85vh] w-[calc(100%-2rem)] max-w-lg -translate-x-1/2 -translate-y-1/2 flex-col gap-4 rounded-lg border border-border bg-background p-6 shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0"
          >
