 ...
 * cookies FAKTYCZNIE pokazana użytkownikowi w przeglądarce. RPC (0164) przyjmie ją tylko,
 * jeśli istnieje w `consent_versions` — inaczej po cichu użyje bieżącej wersji, jak przed 0164.
 */
