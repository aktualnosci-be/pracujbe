 ...
 * i w Server Action. Reguły lustrzane do `submit_contact_message` (0125); baza sprawdza je
...
/** Tematy wiadomości (kolejność = kolejność w formularzu). Zgodne z CHECK w 0125. */
