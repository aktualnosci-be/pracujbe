...
export const ErrorCodes = {
  ...
  JOB_ASSIST_EMPTY: 'JOB_ASSIST_EMPTY',
  JOB_ASSIST_SUSPICIOUS: 'JOB_ASSIST_SUSPICIOUS',
  ...
  PROFILE_ASSIST_EMPTY: 'PROFILE_ASSIST_EMPTY',
  PROFILE_ASSIST_SENSITIVE_DATA: 'PROFILE_ASSIST_SENSITIVE_DATA',
  PROFILE_ASSIST_UNCERTAIN: 'PROFILE_ASSIST_UNCERTAIN',
  PROFILE_ASSIST_SUSPICIOUS: 'PROFILE_ASSIST_SUSPICIOUS',
  PROFILE_ASSIST_NOT_ABOUT_WORK: 'PROFILE_ASSIST_NOT_ABOUT_WORK',
...
const ERROR_MESSAGE_KEYS: Record<ErrorCode, string> = {
  ...
  APPEAL_WINDOW_CLOSED: 'appealWindowClosed',
  ...
  JOB_ASSIST_EMPTY: 'jobAssistEmpty',
  JOB_ASSIST_SUSPICIOUS: 'jobAssistSuspicious',
  ...
  PROFILE_ASSIST_EMPTY: 'profileAssistEmpty',
  PROFILE_ASSIST_SENSITIVE_DATA: 'profileAssistSensitiveData',
  PROFILE_ASSIST_UNCERTAIN: 'profileAssistUncertain',
  PROFILE_ASSIST_SUSPICIOUS: 'profileAssistSuspicious',
  PROFILE_ASSIST_NOT_ABOUT_WORK: 'profileAssistNotAboutWork',
