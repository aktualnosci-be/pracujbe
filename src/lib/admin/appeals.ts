 ...
 * `submit_report_appeal`, `admin_decide_appeal`, CHECK-i `moderation_appeals`, migracja 0102).
 */
...
/**
 * Stan drogi odwołania od decyzji (`moderation_appealable`, 0102): `OK` — można się odwołać;
