...
/**
 * Zgłoszenie wiadomości albo rozmowy przez jej stronę (0108, `kind = 'message_report'`).
...
export interface AdminReportRow {
  ...
  /** Zgłoszenie wiadomości/rozmowy (0108); brak/null dla innych rodzajów. */
