...
export const ACTIVITIES: Record<ActivityId, Activity> = {
  ...
  'ai-translation': {
    ...
    inCode: 'Kolejka tłumaczeń pól tekstowych ofert i profili (rewizje źródła, zadania per język, przekłady, korekty ręczne; 0129). Wpięcie ofert/profili dopiero w #33/#34; za flagą, domyślnie wyłączone.',
    processors: [...HOSTING, 'anthropic'],
    retentionInCode:
