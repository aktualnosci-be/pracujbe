...
export const ACTIVITIES: Record<ActivityId, Activity> = {
  ...
  'analytics-marketing': {
    name: 'Statystyka odwiedzin po zgodzie',
    inCode: 'Beacon Cloudflare Web Analytics ładowany dopiero po zgodzie w kategorii analitycznej (#570); bez cookies i identyfikatorów; wycofanie blokuje dalsze wysyłki. GA i Meta Pixel usunięte (pozostałe cookies _ga*/_fbp/_fbc są czyszczone).',
    processors: ['cloudflare-web-analytics'],
    retentionInCode: 'Cookie zgody ważne 180 dni; portal nie przechowuje danych beaconu (retencja po stronie dostawcy — do ustalenia).',
  },
  'data-rights': {
