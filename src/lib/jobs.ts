...
export interface JobDetail extends JobListItem {
  ...
  expiresAt?: string;
  /** Strona firmy (https, tylko firma verified — 0112) — JSON-LD `hiringOrganization.sameAs`. */
  companyWebsite?: string;
  /** Logo firmy (https, tylko firma verified — 0112) — JSON-LD `hiringOrganization.logo`. */
