...
export const emailCopy: Record<EmailType, Record<Locale, EmailCopy>> = {
  ...
  guestStatusChanged: {
    pl: {
      subject: 'Zmiana statusu aplikacji: {jobTitle}',
      preview: 'Status Twojej aplikacji to teraz: {status}.',
      heading: 'Zmiana statusu aplikacji',
      body: 'Status Twojej aplikacji na ofertę {jobTitle} w firmie {companyName} został zaktualizowany.\n\nAplikację wysłano bez konta. Jeśli firma będzie chciała porozmawiać, skontaktuje się z Tobą podanym adresem e-mail lub telefonem.',
      cta: 'Przeglądaj oferty',
      highlight: '{status}',
      anonymous: {
        preview: 'Status Twojej aplikacji został zaktualizowany.',
        highlight: '',
      },
    ...
    nl: {
      ...
      preview: 'De status van je sollicitatie is nu: {status}.',
      heading: 'Statuswijziging sollicitatie',
      body: 'De status van je sollicitatie voor de vacature {jobTitle} bij {companyName} is bijgewerkt.\n\nJe hebt gesolliciteerd zonder account. Wil het bedrijf verder praten, dan neemt het contact met je op via het opgegeven e-mailadres of telefoonnummer.',
    ...
    fr: {
      ...
      preview: 'Le statut de votre candidature est désormais : {status}.',
      heading: 'Changement de statut',
      body: 'Le statut de votre candidature pour l’offre {jobTitle} chez {companyName} a été mis à jour.\n\nVous avez postulé sans compte. Si l’entreprise souhaite poursuivre, elle vous contactera à l’adresse e-mail ou au numéro de téléphone indiqués.',
      cta: 'Voir les offres',
      highlight: '{status}',
      anonymous: {
        preview: 'Le statut de votre candidature a été mis à jour.',
    ...
    en: {
      ...
      preview: 'Your application status is now: {status}.',
      heading: 'Application status update',
      body: 'The status of your application for the {jobTitle} job at {companyName} has been updated.\n\nYou applied without an account. If the company wants to continue, it will contact you using the email address or phone number you provided.',
      cta: 'Browse jobs',
      highlight: '{status}',
      anonymous: {
        preview: 'Your application status has been updated.',
  ...
  reportRestored: {
    pl: {
      subject: 'Zmiana wyniku Twojej sprawy {caseNumber}',
      preview: 'Cofnęliśmy ograniczenie zgłoszonej treści.',
      heading: 'Ograniczenie cofnięte',
      body: 'Po ponownym przeglądzie cofnęliśmy ograniczenie treści zgłoszonej w Twojej sprawie w serwisie Pracuj.be. Treść może być znów widoczna, chyba że obowiązuje wobec niej inna decyzja.\n\nStatus sprawy sprawdzisz przyciskiem poniżej, podając numer sprawy i kod dostępu z wiadomości potwierdzającej przyjęcie zgłoszenia.',
      cta: 'Sprawdź status sprawy',
      highlight: '{caseNumber}',
      outro: 'Jeśli nie zgadzasz się z tą zmianą, możesz złożyć odwołanie na stronie sprawy, podając numer sprawy {caseNumber} i kod dostępu.',
      footerNote: 'Otrzymujesz tę wiadomość, ponieważ w serwisie Pracuj.be wysłano zgłoszenie z tym adresem e-mail.',
    },
    nl: {
      subject: 'Gewijzigde uitkomst van je dossier {caseNumber}',
      preview: 'We hebben de beperking van de gemelde inhoud opgeheven.',
      heading: 'Beperking opgeheven',
      body: 'Na een nieuwe beoordeling hebben we de beperking opgeheven van de inhoud die in je dossier op Pracuj.be is gemeld. De inhoud kan weer zichtbaar zijn, tenzij er een andere beslissing voor geldt.\n\nDe status van je dossier bekijk je via de knop hieronder, met het dossiernummer en de toegangscode uit de ontvangstbevestiging van je melding.',
      cta: 'Status van je dossier bekijken',
      highlight: '{caseNumber}',
      outro: 'Ben je het niet eens met deze wijziging? Je kunt bezwaar maken op de pagina van je dossier, met dossiernummer {caseNumber} en je toegangscode.',
      footerNote: 'Je ontvangt dit bericht omdat op Pracuj.be een melding met dit e-mailadres is verstuurd.',
    },
    fr: {
      subject: 'Le résultat de votre dossier {caseNumber} a changé',
      preview: 'Nous avons levé la restriction du contenu signalé.',
      heading: 'Restriction levée',
      body: 'Après un nouvel examen, nous avons levé la restriction du contenu signalé dans votre dossier sur Pracuj.be. Le contenu peut de nouveau être visible, sauf si une autre décision s’y applique.\n\nVous pouvez suivre votre dossier avec le bouton ci-dessous, à l’aide du numéro de dossier et du code d’accès indiqués dans le message confirmant la réception de votre signalement.',
      cta: 'Voir le statut du dossier',
      highlight: '{caseNumber}',
      outro: 'Si vous n’êtes pas d’accord avec ce changement, vous pouvez introduire un recours sur la page de votre dossier, avec le numéro de dossier {caseNumber} et votre code d’accès.',
      footerNote: 'Vous recevez ce message car un signalement a été envoyé sur Pracuj.be avec cette adresse e-mail.',
    },
    en: {
      subject: 'The outcome of your case {caseNumber} has changed',
      preview: 'We have lifted the restriction on the reported content.',
      heading: 'Restriction lifted',
      body: 'After a further review, we have lifted the restriction on the content reported in your case on Pracuj.be. The content may be visible again, unless another decision applies to it.\n\nYou can check the status of your case with the button below, using the case number and access code from the email confirming we received your report.',
      cta: 'Check case status',
      highlight: '{caseNumber}',
