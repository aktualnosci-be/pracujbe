...
export const QUEUED_EMAIL_TYPES = [
  ...
  'inactiveCvWarning', // retention_purge_batch (0127) — przed usunięciem CV (RETENTION_MODE)
  'inactiveAccountWarning', // retention_purge_batch (0127) — przed usunięciem konta (RETENTION_MODE)
