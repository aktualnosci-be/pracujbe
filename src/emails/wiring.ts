...
export const QUEUED_EMAIL_TYPES = [
  ...
  'appealReceived', // submit_moderation_appeal / submit_report_appeal (0103) — do odwołującego się
  'appealUpheld', // admin_decide_appeal (0103) → decyzja utrzymana
  'appealReversed', // admin_decide_appeal (0103) → odwołanie uwzględnione
